...
public class MutationTuery extends Tuery<MutationTuery> {
    ...
    * 
    */
    public MutationTuery addIssue(List<AddIssueInput> input, AddIssuePayloadTueryDefinition queryDef) {
        startField("addIssue");
        ...
        _queryBuilder.append('{');
        queryDef.define(new AddIssuePayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery updateIssue(UpdateIssueInput input, UpdateIssuePayloadTueryDefinition queryDef) {
        startField("updateIssue");
        ...
        _queryBuilder.append('{');
        queryDef.define(new UpdateIssuePayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery deleteIssue(IssueFilter filter, DeleteIssuePayloadTueryDefinition queryDef) {
        startField("deleteIssue");
        ...
        _queryBuilder.append('{');
        queryDef.define(new DeleteIssuePayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery addProject(List<AddProjectInput> input, AddProjectPayloadTueryDefinition queryDef) {
        startField("addProject");

        _queryBuilder.append("(input:");
        _queryBuilder.append('[');
        {
            String listSeperator1 = "";
            for (AddProjectInput item1 : input) {
                _queryBuilder.append(listSeperator1);
                listSeperator1 = ",";
                item1.appendTo(_queryBuilder);
            }
        ...
        _queryBuilder.append('{');
        queryDef.define(new AddProjectPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery updateProject(UpdateProjectInput input, UpdateProjectPayloadTueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new UpdateProjectPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery deleteProject(ProjectFilter filter, DeleteProjectPayloadTueryDefinition queryDef) {
        ...
        _queryBuilder.append('{');
        queryDef.define(new DeleteProjectPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery addTask(List<AddTaskInput> input, AddTaskPayloadTueryDefinition queryDef) {
        startField("addTask");
        ...
        _queryBuilder.append('{');
        queryDef.define(new AddTaskPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery updateTask(UpdateTaskInput input, UpdateTaskPayloadTueryDefinition queryDef) {
        startField("updateTask");
        ...
        _queryBuilder.append('{');
        queryDef.define(new UpdateTaskPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery deleteTask(TaskFilter filter, DeleteTaskPayloadTueryDefinition queryDef) {
        startField("deleteTask");
        ...
        _queryBuilder.append('{');
        queryDef.define(new DeleteTaskPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery addTaskAssignment(List<AddTaskAssignmentInput> input, AddTaskAssignmentPayloadTueryDefinition queryDef) {
        startField("addTaskAssignment");

        _queryBuilder.append("(input:");
        _queryBuilder.append('[');
        {
            String listSeperator1 = "";
            for (AddTaskAssignmentInput item1 : input) {
                _queryBuilder.append(listSeperator1);
                listSeperator1 = ",";
                item1.appendTo(_queryBuilder);
            }
        ...
        _queryBuilder.append('{');
        queryDef.define(new AddTaskAssignmentPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery updateTaskAssignment(UpdateTaskAssignmentInput input, UpdateTaskAssignmentPayloadTueryDefinition queryDef) {
        startField("updateTaskAssignment");
        ...
        _queryBuilder.append('{');
        queryDef.define(new UpdateTaskAssignmentPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
    ...
    * 
    */
    public MutationTuery deleteTaskAssignment(TaskAssignmentFilter filter, DeleteTaskAssignmentPayloadTueryDefinition queryDef) {
        startField("deleteTaskAssignment");
        ...
        _queryBuilder.append('{');
        queryDef.define(new DeleteTaskAssignmentPayloadTuery(_queryBuilder));
        _queryBuilder.append('}');
