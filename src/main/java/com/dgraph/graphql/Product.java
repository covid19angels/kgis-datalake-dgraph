...
* äº§ï¿½ï¿½?
*/
public class Product extends AbstractResponse<Product> implements Node, Saleable, Thing {
    public Product() {
    }
    ...
    */
    ...
    public Product setIsSaleable(Boolean arg) {
        optimisticData.put(getKey("isSaleable"), arg);
        return this;
    }

    /**
    *     ï¿½ï¿½?åž‹ï¿½?ï¿½ã€‘ äº§ï¿½ï¿½?çš„åž‹ï¿½?ï¿½ã€‚    
    */
