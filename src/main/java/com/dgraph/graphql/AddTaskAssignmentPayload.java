...
* 
*/
public class AddTaskAssignmentPayload extends AbstractResponse<AddTaskAssignmentPayload> {
    public AddTaskAssignmentPayload() {
    }

    public AddTaskAssignmentPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddTaskAssignmentPayload";
    }
    ...
    */
    ...
    public AddTaskAssignmentPayload setTaskassignment(List<TaskAssignment> arg) {
    ...
    */
    ...
    public AddTaskAssignmentPayload setNumUids(Integer arg) {
