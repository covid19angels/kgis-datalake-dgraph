...
public class TaskPatch implements Serializable {
    ...
    public TaskPatch setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public TaskPatch setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
    ...
    public TaskPatch setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public TaskPatch setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public TaskPatch setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public TaskPatch setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public TaskPatch setAlternateNameInput(Input<String> alternateName) {
    ...
    public TaskPatch setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public TaskPatch setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setAbout(IssueRef about) {
        this.about = Input.optional(about);
        return this;
    }

    public TaskPatch setAboutInput(Input<IssueRef> about) {
        if (about == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.about = about;
    ...
    public TaskPatch setIsPartOf(ProjectRef isPartOf) {
        this.isPartOf = Input.optional(isPartOf);
        return this;
    }

    public TaskPatch setIsPartOfInput(Input<ProjectRef> isPartOf) {
        if (isPartOf == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setWbsNo(String wbsNo) {
        this.wbsNo = Input.optional(wbsNo);
        return this;
    }

    public TaskPatch setWbsNoInput(Input<String> wbsNo) {
        if (wbsNo == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.wbsNo = wbsNo;
    ...
    public TaskPatch setPriority(TaskPriority priority) {
        this.priority = Input.optional(priority);
        return this;
    }

    public TaskPatch setPriorityInput(Input<TaskPriority> priority) {
        if (priority == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setCreator(UserRef creator) {
        this.creator = Input.optional(creator);
        return this;
    }

    public TaskPatch setCreatorInput(Input<UserRef> creator) {
        if (creator == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setWatcher(List<UserRef> watcher) {
        this.watcher = Input.optional(watcher);
        return this;
    }

    public TaskPatch setWatcherInput(Input<List<UserRef>> watcher) {
        if (watcher == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setPlanStart(DateTime planStart) {
        this.planStart = Input.optional(planStart);
        return this;
    }

    public TaskPatch setPlanStartInput(Input<DateTime> planStart) {
        if (planStart == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setPlanFinish(DateTime planFinish) {
        this.planFinish = Input.optional(planFinish);
        return this;
    }

    public TaskPatch setPlanFinishInput(Input<DateTime> planFinish) {
        if (planFinish == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setPercentComplete(Integer percentComplete) {
        this.percentComplete = Input.optional(percentComplete);
        return this;
    }

    public TaskPatch setPercentCompleteInput(Input<Integer> percentComplete) {
    ...
    public TaskPatch setCreatedAt(DateTime createdAt) {
        this.createdAt = Input.optional(createdAt);
        return this;
    }

    public TaskPatch setCreatedAtInput(Input<DateTime> createdAt) {
        if (createdAt == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setUpdatedAt(DateTime updatedAt) {
        this.updatedAt = Input.optional(updatedAt);
        return this;
    }

    public TaskPatch setUpdatedAtInput(Input<DateTime> updatedAt) {
        if (updatedAt == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setParentTask(TaskRef parentTask) {
        this.parentTask = Input.optional(parentTask);
        return this;
    }

    public TaskPatch setParentTaskInput(Input<TaskRef> parentTask) {
        if (parentTask == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setPreviousTask(TaskRef previousTask) {
        this.previousTask = Input.optional(previousTask);
        return this;
    }

    public TaskPatch setPreviousTaskInput(Input<TaskRef> previousTask) {
    ...
    public TaskPatch setSubTasks(List<TaskRef> subTasks) {
        this.subTasks = Input.optional(subTasks);
        return this;
    }

    public TaskPatch setSubTasksInput(Input<List<TaskRef>> subTasks) {
        if (subTasks == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setDependsOn(List<TaskRef> dependsOn) {
        this.dependsOn = Input.optional(dependsOn);
        return this;
    }

    public TaskPatch setDependsOnInput(Input<List<TaskRef>> dependsOn) {
        if (dependsOn == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setAssignments(List<TaskAssignmentRef> assignments) {
        this.assignments = Input.optional(assignments);
        return this;
    }

    public TaskPatch setAssignmentsInput(Input<List<TaskAssignmentRef>> assignments) {
        if (assignments == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public TaskPatch setStatus(TaskStatus status) {
        this.status = Input.optional(status);
        return this;
    }

    public TaskPatch setStatusInput(Input<TaskStatus> status) {
        if (status == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.status = status;
