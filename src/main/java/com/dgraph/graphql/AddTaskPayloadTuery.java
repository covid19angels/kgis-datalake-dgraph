...
* 
*/
public class AddTaskPayloadTuery extends Tuery<AddTaskPayloadTuery> {
    AddTaskPayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddTaskPayloadTuery task(TaskTueryDefinition queryDef) {
    ...
    * 
    */
    public AddTaskPayloadTuery task(TaskArgumentsDefinition argsDef, TaskTueryDefinition queryDef) {
        startField("task");
    ...
    * 
    */
    public AddTaskPayloadTuery numUids() {
        startField("numUids");
