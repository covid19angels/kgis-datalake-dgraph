...
* 
*/
public class AddIssuePayload extends AbstractResponse<AddIssuePayload> {
    public AddIssuePayload() {
    }

    public AddIssuePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddIssuePayload setIssue(List<Issue> arg) {
    ...
    */
    ...
    public AddIssuePayload setNumUids(Integer arg) {
