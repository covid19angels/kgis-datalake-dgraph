...
* shipping details of a bought offer.è´­ç‰©è®¢ï¿½?ï¿½å†…å®¹é¡¹
*/
public class PoderItem extends AbstractResponse<PoderItem> implements Node, Thing {
    ...
    */
    ...
    public Saleable getPoderedItem() {
        return (Saleable) get("poderedItem");
    }

    public PoderItem setPoderedItem(Saleable arg) {
