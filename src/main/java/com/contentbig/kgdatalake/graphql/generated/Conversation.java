...
/**
* ��?对��?】组织之间或特定主题的人员之间的一个或多个消�?�。 �?�以使用isPartOf或hasPart属性将个人消�?�链接到会��?。 One or more messages
* between organizations or people on a particular topic. Individual messages can be linked to the
...
public class Conversation extends AbstractResponse<Conversation> implements Node, Thing {
    ...
    */
    ...
    /**
    *     ��?关于】 事物的关于信�?� The subject matter of the content.    
    */
    ...
    */
    ...
    /**
    *     ��?所在数�?�集目录】所在的数�?�集目录 A data catalog which contains this dataset.    
    */
    ...
    */
    ...
    /**
    *     本会��?Conversation给第三方软件如Github��?阿里云代��?创建的webhook，第三方软件�?�本会��?推��?事件消�?�    
    */
