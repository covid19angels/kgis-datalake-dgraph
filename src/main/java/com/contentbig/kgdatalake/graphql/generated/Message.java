...
/**
* ��?消�?�】由�?���?者�?�给一个或多个组织或个人的信�?� A single message from a sender to one or more organizations or
* people.
*/
public class Message extends AbstractResponse<Message> implements Node, Readable, Thing {
    ...
    */
    ...
    /**
    *     �?�照isPartOf��?从属于】 是它的一部分 Indicates an item or CreativeWork that this item, or CreativeWork (in
    ...
    */
    ...
    /**
    *     ��?�?���?者】 �?�与者的��?属性。例如邮件的�?���?者。 A sub property of participant. The participant who is at
    * the sending end of the action.    
    */
    ...
    /**
    *     ��?�?���?日期】 消�?�被�?���?的日期/时间。 The date/time at which the message was sent.    
    */
    ...
    /**
    *     ��?收件人】 消�?�的直接收件人 A sub property of recipient. The recipient who was directly sent the message.
    */
    ...
    /**
    *     ��?阅读日期】 如果存在�?�个的收件人，就是消�?�被收件人读�?�的日期/时间。 The date/time at which the message has been read by
    ...
    */
    ...
    /**
    *     ��?接收日期】 如果存在�?�个的收件人，就是消�?�被收件人接收的日期/时间。 The date/time the message was received if a single
    * recipient exists.    
    */
    ...
    /**
    *     ��?接收者】 �?�与者的��?属性。 在行动接收端的�?�与者。 A sub property of participant. The participant who is at the
