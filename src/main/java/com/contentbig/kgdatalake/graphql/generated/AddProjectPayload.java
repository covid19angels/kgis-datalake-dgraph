...
* 
*/
public class AddProjectPayload extends AbstractResponse<AddProjectPayload> {
    public AddProjectPayload() {
    }

    public AddProjectPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddProjectPayload setProject(List<Project> arg) {
    ...
    */
    ...
    public AddProjectPayload setNumUids(Integer arg) {
