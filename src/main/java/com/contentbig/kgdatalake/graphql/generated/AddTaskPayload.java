...
* 
*/
public class AddTaskPayload extends AbstractResponse<AddTaskPayload> {
    public AddTaskPayload() {
    }

    public AddTaskPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddTaskPayload setTask(List<Task> arg) {
    ...
    */
    ...
    public AddTaskPayload setNumUids(Integer arg) {
